                                ...
                                @foreach ($products as $product )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" style="margin-left:10px;" onclick="confirm('Are you sure you want to delete') ||event.stopImmediatePropagation()"  wire:click.prevent="deleteProduct({{ $product->id }})">
